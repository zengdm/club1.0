...
Page({
  ...
  scrollTouchStart: function (event) {
    var that = this;
    console.log('scrollTouchStart block event: ', event);
    /*** 根据移动位置, 获取选中节点信息 ***/
    ...
    console.log("scrollTouchStart block moveViewPosition:", movableViewPosition);
    console.log("scrollTouchStart block selectItemInfo:", secInfo);
  ...
  scrollTouchMove: function (event) {
    ...
    console.log('scrollTouchMove optionsListData', that.data.optionsListData)

    console.log("scrollTouchMove block event changedTouches:", event.changedTouches);
    console.log("scrollTouchMove block optionsListData:", optionsListData);
    console.log('scrollTouchMove list data.contents', that.data.contents);
  ...
  scrollTouchEnd: function (event) {
    ...
    console.log('scrollTouchEnd list data.contents', that.data.contents);
    that.setData({
      optionsListData: optionsListData,
  ...
  sortSuccBtn: function () {
    ...
    for (let k in that.data.optionsListData) {
      for (let j in that.data.optionsListData[k]) {
        console.log(j, filters.indexOf(k))
  ...
  sortBtn: function () {
    ...
    console.log('optionsList', that.data.contents);
  ...
  bindPublish: function (e) {
    ...
    if (!that.data.args.content[0].decode.alt) {
      wx.showToast({
        title: '文章内容不能为空',
        image: '/pages/images/warning.png'
      });
  ...
  _addNode: function (data, index) {
    ...
    console.log(that.data.contents);
    // 设置模板统一变量
    that.setData({contents: that.data.contents});
    return isOpt;
  },
  /**
