...
Page({
  ...
  onLoad: function () {
    ...
    // 设置分享内容
    that.shareObj.setShare('新能源车续航排行-电动邦', '/pages/model/rank/mileage/mileage');
  ...
  scrolltolower: function () {
    ...
    console.log('是不是在底部是不是在底部是不是在底部是不是在底部是不是在底部')
    var that = this;
